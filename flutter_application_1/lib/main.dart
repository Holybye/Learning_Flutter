  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          useMaterial3: true,
          colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 174, 34, 255)),
        ),
        home: MyHomePage(),
      ),
    );
...
class FavoritesPage extends StatelessWidget{
  ...
  if(appState.favorites.isEmpty){
    return Center(child: Text("No fav yet: "),
    );
  }
  ...
  return Column(
    ...
    children: [
      Padding(
        ...
        child: Text('This is your favorite words'),
      ),
      Expanded(
        child: GridView(
...
class GeneratorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // var previous_pair = appState.previous;
